...
import { FaHome, FaDatabase, FaClipboardCheck, FaBoxOpen, FaUndo, FaMoneyBillWave, FaHistory } from 'react-icons/fa';
  ...
  return (
    <div className="w-64 h-screen bg-gray-800 text-white fixed">
      ...
      <nav className="mt-4 flex flex-col gap-4 p-4">
        ...
        {/* Tambahan menu History Denda */}
        <Link to="/peminjam/history-denda" className="flex items-center gap-3 hover:bg-gray-700 p-2 rounded">
          <FaHistory className="text-xl" />
          <span className="text-lg">History Denda</span>
        </Link>
      </nav>
    </div>
  );
